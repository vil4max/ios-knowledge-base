...
### Q1
- **Question:** что держать в этой папке?
- **Answer:** свой расширяемый глоссарий (или выжимки из заметок по темам **I–X**), чтобы быстро вспоминать формулировки перед собесом или ревью.
- **Follow-up:** как не дублировать темы?
- **Follow-up answer:** здесь только термин → строка определения; развёрнутые Q&A остаются в папке соответствующей темы.
