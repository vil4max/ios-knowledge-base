...
#### MVC (~34%) — второе место (часто legacy)
...
#### VIPER + Clean (~18%) — enterprise / тяжёлые модули
...
### Устная заготовка (30 сек, с цифрами)
...
## Миграция legacy-монолита: практический порядок
