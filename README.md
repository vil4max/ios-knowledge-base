...
Every topic has a **30-second summary**, **Apple documentation links**, **Focus vs Defer**, **key concepts**, **exercises**, **WWDC / external references**, and **Q&A cards** in **RU + EN**. On the site, **English is visible by default**; click **«По-русски»** to expand Russian. Format: [bilingual-format.md](reference/curated/notes/bilingual-format.md).
